...
export const agentAvatarIcons = [
  ...
  { id: "message-square", icon: MessageSquare, label: "消息" },
  { id: "search", icon: Search, label: "搜索" },
  { id: "settings", icon: Settings, label: "设置" },
  { id: "users", icon: Users, label: "用户" },
  { id: "briefcase", icon: Briefcase, label: "公文包" },
  { id: "building2", icon: Building2, label: "建筑" },
  { id: "graduation-cap", icon: GraduationCap, label: "教育" },
  { id: "heart-pulse", icon: HeartPulse, label: "医疗" },
  { id: "scale", icon: Scale, label: "法律" },
  { id: "landmark", icon: Landmark, label: "政府" },
  { id: "car", icon: Car, label: "交通" },
  { id: "plane", icon: Plane, label: "航空" },
  { id: "shopping-cart", icon: ShoppingCart, label: "购物" },
  { id: "wallet", icon: Wallet, label: "金融" },
  { id: "calculator", icon: Calculator, label: "计算" },
  { id: "lightbulb", icon: Lightbulb, label: "创意" },
  { id: "microscope", icon: Microscope, label: "科研" },
  { id: "palette", icon: Palette, label: "设计" },
  { id: "music", icon: Music, label: "音乐" },
  { id: "camera", icon: Camera, label: "摄影" },
  { id: "home", icon: Home, label: "房产" },
