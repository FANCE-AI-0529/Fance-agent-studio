    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="fixed bottom-20 right-4 z-40 h-12 w-12 rounded-full bg-card border border-border shadow-lg hover:shadow-xl md:bottom-4"
        >
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button
              variant="outline"
              className="h-auto flex-col gap-2 p-4"
              onClick={() => globalThis.open("https://github.com/fance-studio/fance-studio/wiki", "_blank")}
            >
          ...
          <div className="border-t border-border pt-4 space-y-3">
            ...
            <div className="space-y-2">
              <Button 
                ...
                onClick={() => {
                  globalThis.open("https://crisp.chat/", "_blank");
                }}
              >
