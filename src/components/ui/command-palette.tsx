  ...
  const navigationCommands: CommandItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: MessageSquare,
        shortcut: "⌘R",
        action: () => navigate("/hive?tab=runtime"),
      ...
      },
      {
        ...
        icon: Layers,
        shortcut: "⌘B",
        action: () => navigate("/hive?tab=builder"),
      ...
      },
      {
        ...
        icon: Wrench,
        shortcut: "⌘F",
        action: () => navigate("/hive?tab=foundry"),
      ...
      },
      {
        ...
        label: "知识库",
        icon: Database,
        action: () => navigate("/hive?tab=knowledge"),
  ...
  const actionCommands: CommandItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        label: "创建新技能",
        icon: FileCode,
        action: () => navigate("/hive?tab=foundry&dev=true"),
  ...
  const agentCommands: CommandItem[] = useMemo(
    () =>
      agents.slice(0, 5).map((agent) => ({
        ...
        label: agent.name,
        icon: Bot,
        action: () => navigate(`/hive?tab=runtime&agentId=${agent.id}`),
